...
import {
	...
	INTEGRATION_SERVICE_DEFS,
} from "../types/settings";

export type InteractionMode = "build" | "edit" | "chat" | "ask";
...
export const useSettingsStore = create<SettingsStore>((set, get) => ({
	...
	integrations: INTEGRATION_SERVICE_DEFS.map((d) => ({
		...d,
		connected: false,
		configured: false,
	})),
	...
	setDefaultProvider: (provider: string) =>
		set({ defaultProvider: provider, llmProvider: provider }),
