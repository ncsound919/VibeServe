...
export const gitHookExtension: ExtensionManifest = {
	...
	version: "1.0.0",
	description:
		"Sample extension demonstrating git hooks integration with auto-format and lint on save",
	author: "Nexus",
...
export function handleFileSave(
	...
	const isCodeFile = ["ts", "tsx", "js", "jsx", "py", "go", "rs"].includes(
		ext || "",
	);
