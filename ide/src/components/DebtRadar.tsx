...
export const DebtRadar = () => {
	...
	return (
		<div className="relative">
			...
			>
				<ShieldAlert
					className={`w-3.5 h-3.5 ${getScoreColor(report.debtScore)} animate-pulse-soft`}
				/>
				...
				{isOpen && (
					...
					>
						<div className="flex items-center justify-between mb-3">
							...
							<ShieldAlert
								className={`w-3 h-3 ${getScoreColor(report.debtScore)}`}
							/>
						</div>
						...
						<div className="space-y-3">
							<div className="flex justify-between items-center">
								...
								<span
									className={`text-xs font-mono font-bold uppercase ${report.complexity === "high" ? "text-red-400" : "text-green-400"}`}
								>
									{report.complexity}
								</span>
							</div>
