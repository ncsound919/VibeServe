...
import { DetectedError, ErrorKind } from './errorContextService';
...
const KIND_COLORS: Record<ErrorKind, { bg: string; text: string }> = {
  runtime:   { bg: 'var(--color-background-danger)', text: 'var(--color-text-danger)' },
  syntax:    { bg: 'var(--color-background-danger)', text: 'var(--color-text-danger)' },
  typecheck: { bg: 'var(--color-background-warning)', text: 'var(--color-text-warning)' },
  build:     { bg: 'var(--color-background-warning)', text: 'var(--color-text-warning)' },
  test:      { bg: 'var(--color-background-info)', text: 'var(--color-text-info)' },
  lint:      { bg: 'var(--color-background-secondary)', text: 'var(--color-text-secondary)' },
  unknown:   { bg: 'var(--color-background-danger)', text: 'var(--color-text-danger)' },
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {new Date(error.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
        </span>
      </div>
    </div>
  );
