...
const presets: PromptPreset[] = [
	{
		...
		icon: "🐛",
		prompt:
			"Find and fix the bug in my code. Analyze the issue and provide a corrected implementation.",
	},
	{
		id: "refactor",
		label: "Refactor",
	...
	},
	{
		...
		icon: "👀",
		prompt:
			"Review this code and provide feedback on quality, security, and best practices.",
	},
];
