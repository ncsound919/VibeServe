...
import type { PipelineExecutionData, RepoTrend } from "../../types";
	...
	if (!repos || repos.length === 0) {
		return (
			<div className="flex flex-col items-center justify-center h-64 bg-[#151619] border border-[#2d2e32] rounded-xl gap-4">
				<p className="text-[#4a4b50] font-mono text-sm">
					...
					return (
						...
						>
							...
							<div className="grid grid-cols-2 gap-3 mb-4 mt-6 border-t border-[#1a1b1e] pt-4">
								<div>
									<div className="text-[8px] font-mono text-[#4a4b50] uppercase mb-1">
										Stack Spectrum
									</div>
									<div className="text-[10px] text-[#A1A1AA] font-mono truncate">
										{repo.stack || "ANALYST_PENDING"}
									</div>
								</div>
