...
import { CheckCircle2, RefreshCcw, Wrench, XCircle } from "lucide-react";
		...
		>
			<div className="flex items-center gap-3 mb-3">
				...
				>
					<Wrench
						size={16}
						className={autoFixActive ? "text-amber-400" : "text-blue-400"}
					/>
				</div>
				<div>
					<h4 className="text-[10px] font-bold text-blue-400 uppercase tracking-[0.2em] font-mono">
						{autoFixActive
							? "Auto-Fix Active"
							: `Auto-Fix Results (${fixAttempts.length} attempts)`}
					</h4>
					<p className="text-[9px] font-mono text-[#4a4b50]">
						{autoFixActive
							? "Analyzing error and generating fixes..."
									...
									<span
										className={cn(
											...
											attempt.errorType === "network"
												...
												: attempt.errorType === "dependency"
													? "bg-purple-500/10 text-purple-400"
													: attempt.errorType === "compilation"
