		...
		<div className="bg-[#151619] border border-[#2d2e32] rounded-xl overflow-hidden">
			<div className="flex items-center justify-between px-4 py-3 border-b border-[#2d2e32]">
				...
				<div className="flex items-center gap-3 text-[9px] font-mono">
					...
					<span
						className={cn(
							totalIssues > 0 ? "text-rose-400" : "text-emerald-400",
						)}
					>
						{totalIssues} issues
					</span>
					...
					return (
						<div key={analysis.filePath}>
							<div
								...
								onClick={() =>
									setExpandedFile(isExpanded ? null : analysis.filePath)
								}
							>
							...
							<AnimatePresence>
								{isExpanded && (
									...
									>
										...
										{analysis.issues.length > 0 && (
											<div className="mb-3">
												<div className="text-[9px] font-mono text-[#4a4b50] uppercase mb-2">
													Issues
												</div>
												<div className="space-y-1">
													{analysis.issues.map((issue, i) => (
														<div
															key={i}
															className={cn(
																"flex items-center gap-2 px-2 py-1 rounded text-[9px] font-mono border",
											...
											<div className="mb-3">
												...
												<div className="flex flex-wrap gap-1">
													{analysis.symbols.slice(0, 10).map((symbol, i) => (
														<span
															key={i}
															className="flex items-center gap-1 px-1.5 py-0.5 bg-[#151619] rounded text-[8px] font-mono text-[#8E9299]"
														>
