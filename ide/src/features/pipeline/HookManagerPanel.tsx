							...
							>
								...
								<div className="flex items-center gap-2">
									{result && (
										<div
											className={cn(
												"px-2 py-0.5 rounded text-[9px] font-mono flex items-center gap-1",
												result.passed
								...
								{isExpanded && (
									...
									>
										<div className="grid grid-cols-2 gap-3 text-[10px]">
											<div>
												<div className="text-[#4a4b50] font-mono mb-1">
													ACTION
												</div>
												<div className="text-[#8E9299] font-mono uppercase">
													{hook.action}
												</div>
											</div>
											{hook.condition && (
												<div>
													...
													<div className="text-[#8E9299] font-mono">
														{hook.condition}
													</div>
												</div>
											)}
													...
													<div>
														...
														<div className="space-y-1 max-h-20 overflow-y-auto">
															{result.logs.map((log, i) => (
																<div
																	key={i}
																	className="text-[9px] font-mono text-emerald-500/70"
																>
																	{log}
																</div>
															))}
