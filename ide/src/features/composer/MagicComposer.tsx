...
import { ArrowRight, Shield, Sparkles, Wand2, Zap } from "lucide-react";
		...
		<div className="max-w-3xl mx-auto py-12 px-6">
			<div className="text-center mb-12">
				...
				<h1 className="text-4xl font-bold text-white mb-4 tracking-tight">
					What can I <span className="text-indigo-400">build</span> for you
					today?
				</h1>
				...
				{[
					{
						...
						desc: "Auto-scan for secrets and vulns",
					},
					{
						icon: Zap,
						title: "Zero Latency",
						desc: "Sub-100ms local intelligence",
					},
					{
						icon: Wand2,
						title: "Multi-Agent",
						desc: "Parallel coordination of 5+ agents",
					},
				].map((feat, i) => (
					<div
						key={i}
						className="p-4 rounded-xl border border-[#1a1b1e] hover:border-[#2d2e32] transition-colors group"
					>
						<feat.icon
							size={20}
							className="text-[#4a4b50] group-hover:text-indigo-400 transition-colors mb-3"
						/>
