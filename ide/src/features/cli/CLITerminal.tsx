...
export const CLITerminal = ({
	...
	const [pendingProvider, setPendingProvider] = useState<
		"opencode" | "openrouter" | "deepseek" | null
	>(null);
	...
	return (
		<div className="bg-[#0a0a0c] border border-[#2d2e32] rounded-xl flex flex-col h-[450px] overflow-hidden shadow-2xl relative">
			...
			<form
				...
				className="p-4 bg-[#151619] border-t border-[#2d2e32] flex gap-3"
			>
