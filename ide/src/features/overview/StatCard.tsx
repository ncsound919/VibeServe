		...
		<motion.div
			...
			style={
				hovered
					? {
							boxShadow:
								"0 0 25px rgba(16,185,129,0.1), inset 0 0 25px rgba(16,185,129,0.02)",
						}
					: {}
			}
		>
			...
			<p
				...
				className="text-[#8E9299] text-xs font-mono uppercase tracking-widest mb-1"
			>
				{title}
			</p>
			<div className="flex items-baseline gap-2">
				<h3
					...
					className="text-3xl font-medium text-white group-hover:text-emerald-200 transition-colors"
				>
					{value}
				</h3>
				{unit && (
					<span className="text-[#8E9299] text-sm font-mono">{unit}</span>
				)}
			</div>
			{trend && (
