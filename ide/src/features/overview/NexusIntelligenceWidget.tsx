		...
		<div className="bg-[#151619] border border-[#2d2e32] rounded-xl overflow-hidden">
				...
				<div className="space-y-4">
					...
					<div className="grid grid-cols-2 gap-3">
						<div className="bg-[#0a0a0c] p-3 rounded-lg border border-[#1a1b1e]">
							<div className="text-[9px] text-[#4a4b50] uppercase mb-1">
								Symbols
							</div>
				...
				<div className="space-y-4">
					...
					<div className="bg-[#0a0a0c] p-4 rounded-lg border border-[#1a1b1e] relative overflow-hidden group">
						...
						<div className="text-[10px] text-[#8E9299] mb-2 leading-tight">
							{activeContext?.summary ??
								"Serena is standing by to enrich your prompts with relevant codebase context."}
						</div>
						{activeContext && (
							<div className="flex gap-2 flex-wrap mt-3">
								{Array.from(
									new Set(activeContext.items.map((i) => i.source)),
								).map((source) => (
									<span
										key={source}
										className="text-[9px] px-2 py-0.5 rounded bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 uppercase font-mono"
									>
										{source}
									</span>
								))}
					...
					<div className="grid grid-cols-3 gap-2">
						<div className="text-center p-2 rounded bg-[#0a0a0c]/50 border border-[#1a1b1e]">
							...
							<div className="text-[8px] text-[#4a4b50] uppercase">
								Semantic
							</div>
						</div>
						<div className="text-center p-2 rounded bg-[#0a0a0c]/50 border border-[#1a1b1e]">
			...
			<div className="px-6 py-3 bg-[#0a0a0c]/30 border-t border-[#1a1b1e] flex justify-between items-center text-[9px] font-mono text-[#4a4b50]">
				...
				<span className="text-indigo-500/50">
					MANDATORY_CODE_AWARENESS: ENABLED
				</span>
			</div>
		</div>
	);
