...
export const RAGIntelligenceDisplay = ({
	rag,
}: RAGIntelligenceDisplayProps) => (
	<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
		<div className="bg-[#0a0a0c] border border-blue-500/20 p-5 rounded-xl relative overflow-hidden group">
			...
			<div className="text-[10px] font-mono text-blue-400 uppercase tracking-widest mb-3">
				Knowledge Index Hub
			</div>
			<div className="flex items-end gap-3 mb-4">
				<div className="text-3xl font-bold text-white leading-none">
					{rag.indexedDocs.toLocaleString()}
				</div>
				<div className="text-[10px] font-mono text-[#4a4b50] pb-1 uppercase">
					Synced Documents
				</div>
			</div>
			<div className="text-[9px] font-mono text-[#4a4b50] uppercase">
				Last Vector Sync: {rag.lastSync}
			</div>
		</div>
