...
import { LANE_DESCRIPTIONS, PROVIDER_OPTIONS } from "../../types/settings";
...
function LaneConfigCard({
	...
	return (
		...
		>
			...
			{description && (
				<p className="text-[9px] text-[#4a4b50] mb-2 leading-relaxed">
					{description}
				</p>
			)}
		...
		<div className="bg-[#1a1b1e]/50 border border-[#2d2e32] p-5 rounded-xl">
			<div className="flex items-center justify-between mb-5">
				...
				<div className="flex items-center gap-3">
					...
					<button
						onClick={onRefresh}
						className="p-1 hover:bg-[#2d2e32] rounded transition-colors"
					>
