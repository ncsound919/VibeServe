...
const TASK_TEMPLATES = [
	...
	{
		category: "Automation",
		tasks: ["Write tests", "Generate docs", "Refactor code", "Add comments"],
	},
];
	...
	const [messages, setMessages] = useState<Message[]>([
		{
			...
			role: "assistant",
			content:
				"Hi! I'm Nexus AI. Describe what you want to build, and I'll help you create it. Try using one of the suggestions below or describe your idea in plain language.",
			timestamp: Date.now(),
