						...
						<motion.div
							...
							style={
								hovered === i
									? {
											boxShadow:
												"0 0 30px rgba(16,185,129,0.15), 0 0 60px rgba(16,185,129,0.05), inset 0 0 30px rgba(16,185,129,0.03)",
										}
									: {}
							}
						>
							...
							<div className="p-3 relative">
								...
								<h4 className="text-sm font-medium text-white mb-2 line-clamp-2 leading-snug group-hover:text-emerald-200 transition-colors">
									{video.title}
								</h4>
								<div className="flex justify-between items-center">
									<span className="text-[9px] font-mono text-[#4a4b50] truncate max-w-[55%]">
										{video.channel}
									</span>
