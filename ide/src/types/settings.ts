...
export const LANE_DESCRIPTIONS: Record<string, string> = {
	...
	agent_brain:
		"Central reasoning engine for multi-step planning and decision-making.",
	tool_calling: "Manages API tool selection, execution, and result parsing.",
	cross_domain:
		"Synthesizes knowledge across coding, business, and agent domains.",
};
...
export const INTEGRATION_SERVICE_DEFS: Omit<
