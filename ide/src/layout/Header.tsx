...
import { Activity, Cpu, MessageSquare, RefreshCcw, Zap } from "lucide-react";
...
export const Header = ({
	...
	return (
		<header
			className="h-16 border-b border-[#21262d] flex items-center justify-between px-6 bg-[#161b22] sticky top-0 z-50"
			role="banner"
			aria-label="VibeServe header"
		>
			<div className="flex items-center gap-4">
				...
				<div>
					<h1 className="text-sm font-mono uppercase tracking-[0.2em] font-bold text-[#c9d1d9]">
						VibeServe
					</h1>
